...
<head>
    ...
    <title>Tela de Compra - Blusão Jordan X Paris Saint-German Feminino</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/moletons/MT06.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="titulo">
                <h1>BLUSÃO JORDAN X PARIS SAINT-GERMAN FEMININO</h1>
            </div>
