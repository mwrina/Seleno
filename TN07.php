...
<head>
    ...
    <title>Tela de Compra - Tênis Adidas Forum Low X Jeremy Scott Bege</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/tenis/TN07.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="titulo">
                <h1>ADIDAS FORUM LOW X JEREMY SCOTT BEGE 1</h1>
            </div>
