...
<head>
    ...
    <title>Tela de Compra - Camiseta Nike Basquete Casual Masculina - Just Do It</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/camisetas/CAM08.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$109,90</p>
                <p id="preco2">R$78,02</p>
            </div>

            <div id="titulo">
                <h1>CAMISETA NIKE BASQUETE CASUAL MASCULINA - JUST DO IT</h1>
            </div>
