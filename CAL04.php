...
<head>
    ...
    <title>Tela de Compra - Calça Vans Authentic Chino Relaxed Masculina</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/calcas/CAL04.jpg" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$399,99</p>
                <p id="preco2">R$283,99</p>
            </div>

            <div id="titulo">
                <h1>CALÇA VANS AUTHENTIC CHINO RELAXED MASCULINA</h1>
            </div>
