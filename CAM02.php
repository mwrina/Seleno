...
<head>
    ...
    <title>Tela de Compra - Camiseta Puma HC Pocket Masculina</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/camisetas/CAM02.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$130,00</p>
                <p id="preco2">R$80,00</p>
            </div>

            <div id="titulo">
                <h1>CAMISETA PUMA HC POCKET MASCULINA</h1>
            </div>
