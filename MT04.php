...
<head>
    ...
    <title>Tela de Compra - Casaco Nike Sportwear Masculino - Have a Nike Day</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/moletons/MT04.jpg" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="titulo">
                <h1>CASACO NIKE SPORTWEAR MASCULINO - HAVE A NIKE DAY</h1>
            </div>
