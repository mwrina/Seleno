...
<head>
    ...
    <title>Tela de Compra - Moletom Feminino Capuz Fleece Adicolor Essentials</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/moletons/MT02.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="titulo">
                <h1>MOLETOM FEMININO CAPUZ FLEECE ADICOLOR ESSENTIALS</h1>
            </div>
