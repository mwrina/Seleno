...
<head>
    ...
    <title>Tela de Compra - Camiseta Jordans The Shoes Masculina</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/camisetas/CAM06.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$350,00</p>
                <p id="preco2">R$280,00</p>
            </div>

            <div id="titulo">
                <h1>CAMISETA JORDANS THE SHOES MASCULINA</h1>
            </div>
