...
<head>
    ...
    <title>Tela de Compra - Moletom Cropped Adidas Feminino Hoodie</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/moletons/MT03.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="titulo">
                <h1>MOLETOM CROPPED ADIDAS FEMININO HOODIE</h1>
            </div>
