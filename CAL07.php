...
<head>
    ...
    <title>Tela de Compra - Calça Legging Nike One 2.0 Feminina</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/calcas/CAL07.jpg" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$279,99</p>
                <p id="preco2">R$132,99</p>
            </div>

            <div id="titulo">
                <h1>CALÇA LEGGING NIKE ONE 2.0 FEMININA</h1>
            </div>
