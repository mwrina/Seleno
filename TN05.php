...
<head>
    ...
    <title>Tela de Compra - Tênis Nike Branco com Vermelho</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/tenis/TN05.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$1200,00</p>
                <p id="preco2">R$960,00</p>
            </div>

            <div id="titulo">
                <h1>NIKE BRANCO COM VERMELHO</h1>
            </div>
