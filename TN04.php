...
<head>
    ...
    <link rel="stylesheet" href="css/compraProds.css">
    <title>Tela de Compra - Tênis Nike Air Jordan 1 High OG Grey Fog Branco com Preto</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/tenis/TN04.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$1500,00</p>
                <p id="preco2">R$1155,00</p>
            </div>

            <div id="titulo">
                <h1>NIKE AIR JORDAN 1 HIGH OG GREY FOG BRANCO COM PRETO</h1>
            </div>
            ...
            <form>
                ...
                <div class="linTam">
                    <div class="tam1">
                        <button name="tamanho" class="tam">33</button>
                    </div>

                    <div class="tam1">
                        <button name="tamanho" class="tam">34</button>
                    </div>
                    <div class="tam1">
                        <button name="tamanho" class="tam">35</button>
                    </div>

                    <div class="tam1">
                        <button name="tamanho" class="tam">36</button>
                    </div>

                    <div class="tam1">
                        <button name="tamanho" class="tam">37</button>
                    </div>

                    <div class="tam1">
                        <button name="tamanho" class="tam">38</button>
                    </div>
                </div>

                <div class="linTam">
                    <div class="tam1">
                        <button name="tamanho" class="tam">39</button>
                    </div>

                    <div class="tam1">
                        <button name="tamanho" class="tam">40</button>
                    </div>

                    <div class="tam1">
                        <button name="tamanho" class="tam">41</button>
                    </div>

                    <div class="tam1">
                        <button name="tamanho" class="tam">42</button>
                    </div>

                    <div class="tam1">
                        <button name="tamanho" class="tam">43</button>
                    </div>

                    <div class="tam1">
                        <button name="tamanho" class="tam">44</button>
                    </div>
                </div>
