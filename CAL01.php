...
<head>
    ...
    <title>Tela de Compra - Calça Jordan X Paris Saint-Germain Feminina</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/calcas/CAL01.jpg" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$449,99</p>
                <p id="preco2">R$314,99</p>
            </div>

            <div id="titulo">
                <h1>CALÇA JORDAN X PARIS SAINT-GERMAIN FEMININA</h1>
            </div>
