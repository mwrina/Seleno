...
<head>
    ...
    <title>Tela de Compra - Camiseta Vans Easy Deco</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/camisetas/CAM01.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$229,90</p>
                <p id="preco2">R$165,50</p>
            </div>

            <div id="titulo">
                <h1>CAMISETA VANS EASY DECO</h1>
            </div>
