...
<head>
    ...
    <title>Tela de Compra - Calça Vans Authentic Chino Glide Relaxtaper Masculina</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/calcas/CAL05.jpg" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$479,99</p>
                <p id="preco2">R$359,99</p>
            </div>

            <div id="titulo">
                <h1>CALÇA VANS AUTHENTIC CHINO GLIDE RELAXTAPER MASCULINA</h1>
            </div>
