...
<head>
    ...
    <title>Tela de Compra - Calça Nike X Hello Kitty Azul Unissex</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/calcas/CAL06.jpg" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$412,77</p>
                <p id="preco2">R$288,93</p>
            </div>

            <div id="titulo">
                <h1>CALÇA NIKE X HELLO KITTY AZUL UNISSEX</h1>
            </div>
