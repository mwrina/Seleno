...
<head>
    ...
    <title>Tela de Compra - Tênis Nike Air Jordan 1 Low OG Branco com Azul</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/tenis/TN03.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$500,00</p>
                <p id="preco2">R$375,00</p>
            </div>

            <div id="titulo">
                <h1>NIKE AIR JORDAN 1 LOW OG BRANCO COM AZUL</h1>
            </div>
