...
<head>
    ...
    <title>Tela de Compra - Tênis Nike Air Jordan 3 Retrô Branco e Roxo</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/tenis/TN02.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                ...
                <p id="preco2">R$1050,00</p>
            </div>

            <div id="titulo">
                <h1>NIKE AIR JORDAN 3 RETRO BRANCO COM ROXO</h1>
            </div>
