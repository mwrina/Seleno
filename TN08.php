...
<head>
    ...
    <title>Tela de Compra - Tênis Adidas X_PLR Cinza 1</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/tenis/TN08.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$379,90</p>
                <p id="preco2">R$269,72</p>
            </div>

            <div id="titulo">
                <h1>ADIDAS X_PLR CINZA 1</h1>
            </div>
