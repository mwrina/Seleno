...
<head>
    ...
    <title>Tela de Compra - Camiseta Vans Happy Mushrooms SS - Off The Wall Crew</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/camisetas/CAM05.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco2">R$200,00</p>
            </div>

            <div id="titulo">
                <h1>CAMISETA VANS HAPPY MUSHROOMS SS - OFF THE WALL CREW</h1>
            </div>
