...
<head>
    ...
    <title>Tela de Compra - Tênis Adidas NMD R1 Primeblue Branco</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/tenis/TN01.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$450,00</p>
                <p id="preco2">R$346,00</p>
            </div>

            <div id="titulo">
                <h1>TÊNIS ADIDAS NMD R1 PRIMEBLUE BRANCO</h1>
            </div>
