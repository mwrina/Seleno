...
<head>
    ...
    <title>Tela de Compra - Calça Nike Sportswear Essential Collection Feminina</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/calcas/CAL03.jpg" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$349,99</p>
                <p id="preco2">R$249,99</p>
            </div>

            <div id="titulo">
                <h1>NIKE SPORTSWEAR ESSENTIAL COLLECTION FEMININA</h1>
            </div>
