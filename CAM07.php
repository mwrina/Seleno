...
<head>
    ...
    <title>Tela de Compra - Camiseta Nike SB Masculina</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/camisetas/CAM07.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$149,99</p>
                <p id="preco2">R$104,99</p>
            </div>

            <div id="titulo">
                <h1>CAMISETA NIKE SB MASCULINA</h1>
            </div>
