...
<head>
    ...
    <title>Tela de Compra - Calça Nike Air Masculina - Just Do It</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/calcas/CAL08.jpg" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$629,99</p>
                <p id="preco2">R$409,99</p>
            </div>

            <div id="titulo">
                <h1>CALÇA NIKE AIR MASCULINA - JUST DO IT</h1>
            </div>
