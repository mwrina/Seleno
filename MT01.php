...
<head>
    ...
    <title>Tela de Compra - Moletom Sportwear Masculino - Authorized Personnel Only</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/moletons/MT01.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                ...
                <p id="preco2">R$346,50</p>
            </div>

            <div id="titulo">
                <h1>MOLETOM NIKE SPORTWEAR MASCULINO - AUTHORIZED PERSONNEL ONLY</h1>
            </div>
