...
<head>
    ...
    <title>Tela de Compra - Camiseta Puma Rare Basketball Masculina</title>
</head>
<body>
...
<!-- GERAL -->
    ...
    <div class="geral">
        ...
        <div class="imgProd">
            <img src="imgs/camisetas/CAM03.png" id="imgProd">
        </div>
        ...
        <div class="lateralProd">
            ...
            <div id="preco">
                <p id="preco1">R$150,00</p>
                <p id="preco2">R$127,50</p>
            </div>

            <div id="titulo">
                <h1>CAMISETA PUMA RARE BASKETBALL MASCULINA</h1>
            </div>
